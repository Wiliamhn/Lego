    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form method="post" action="admin/supplier/{{ $supplier->id }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="name" id="name" placeholder="Nhập tên nhà cung cấp" type="text"
