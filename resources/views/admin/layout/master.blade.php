...
<head>
    ...
    <link href="./dashbroad/main.css" rel="stylesheet">
    <link href="./dashbroad/my_style.css" rel="stylesheet">
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class=""><img style="height: 40px; margin-left: 50px" src="front/images/icons/lego1.png"></div>
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-secondary">
                                        <div class="menu-header-image opacity-5"
                                            style="background-image: url('dashbroad/assets/images/dropdown-header/abstract2.jpg');">
                                        </div>
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-success">
                                        <div class="menu-header-image opacity-1"
                                            style="background-image: url('dashbroad/assets/images/dropdown-header/abstract3.jpg');">
                                        </div>
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-plum-plate">
                                        <div class="menu-header-image"
                                            style="background-image: url('dashbroad/assets/images/dropdown-header/abstract4.jpg');">
                                        </div>
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true"
                                ...
                                <div class="dropdown-menu-header mb-0">
                                    <div class="dropdown-menu-header-inner bg-deep-blue">
                                        <div class="menu-header-image opacity-1"
                                            style="background-image: url('dashbroad/assets/images/dropdown-header/city3.jpg');">
                                        </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/1.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/2.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/3.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/4.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/5.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/9.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/7.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="dashbroad/assets/images/avatars/8.jpg"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                        <div class="menu-header-image opacity-05"
                                            style="background-image: url('dashbroad/assets/images/dropdown-header/city2.jpg');">
                                        </div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="front1/img/user/{{Auth::user()->avatar ?? '_default-user.png'}}"
                                                alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle"
                                                                        src="front1/img/user/{{Auth::user()->avatar ?? '_default-user.png'}}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href="./admin/logout" class="btn-pill btn-shadow btn-shine btn btn-focus">Thoát</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <ul class="list-group">
                                ...
                                <div class="swatch-holder swatch-holder-img active">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/city1.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/city2.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/city3.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/city4.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/city5.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/abstract1.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/abstract2.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/abstract3.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/abstract4.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="dashbroad/assets/images/sidebar/abstract5.jpg">
                                    </a>
                                </div>
                            </li>-->
                            </ul>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-plugin"></i>Thông tin chung
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="./admin/order" class="{{(request()->segment(2) == 'order') ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Các đơn hàng
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="./admin/supplier" class="{{ (request()->segment(2) == 'supplier') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Nhà cung cấp
                                        </a>
                                    </li>
                                       <li>
                                        <a href="./admin/import-invoice" class="{{ (request()->segment(2) == 'import-invoice') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Hóa đơn nhập
                                        </a>
                                    </li>
                                    <li class="{{ request()->segment(2) == 'statistics' ? 'mm-active' : '' }}">
                                        <a href="{{ route('admin.statistics.index') }}">
                                            <i class="metismenu-icon"></i>Biểu đồ doanh thu và lợi nhuận
                                        </a>
                                    </li>
                                    <li class="{{ (request()->segment(2) == 'report') ? 'mm-active' : '' }}">
                                        <a href="#" class="has-arrow">
                                            <i class="metismenu-icon"></i>Báo cáo thống kê khách hàng
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="./admin/report/customer/topCustomers">
                                                    <i class="metismenu-icon"></i>Khách mua nhiều
                                                </a>
                                            </li>

                                        </ul>
                                    </li>
                                    <li class="{{ (request()->segments(18) == 'report') ? 'mm-active' : '' }}">
                                        <a href="#" class="has-arrow">
                                            <i class="metismenu-icon"></i>Báo cáo thống kê sản phẩm
                                        </a>
                                        <ul>
                                            
                                            
                                            <li>
                                                <a href="./admin/report/product/productBestSeller">
                                                    <i class="metismenu-icon"></i>Sản phẩm bán chạy
                                                </a>
                                            </li>
                                            
                                            
                                            <li>
                                                <a href="./admin/report/product/topViewedProducts">
                                                    <i class="metismenu-icon"></i>Lượt xem sản phẩm
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                            ...
                                            <div class="d-none popover-custom-content">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                        <div class="menu-header-image opacity-1"
                                                            style="background-image: url('dashbroad/assets/images/dropdown-header/city5.jpg');">
                                                        </div>
                                                        <div class="menu-header-content text-dark">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="42" class="rounded" src="dashbroad/assets/images/avatars/1.jpg"
                                                    alt="" />
                                            </div>
                                        </div>
                                        <div class="widget-content-left">
                                        ...
                                        <h4 class="timeline-title">Something not important
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/1.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/2.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/3.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/4.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/5.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/6.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/7.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="dashbroad/assets/images/avatars/8.jpg" alt="">
                                                    </div>
                                                </div>
    ...
    <script src="./dashbroad/assets/scripts/jquery-3.2.1.min.js"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>

    <script type="text/javascript" src="./dashbroad//assets/scripts/main.js"></script>
    <script type="text/javascript" src="./dashbroad//assets/scripts/my_script.js"></script>
