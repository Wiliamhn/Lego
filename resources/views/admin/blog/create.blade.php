            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form method="post" action="admin/blog" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                ...
                                <small class="form-text text-muted">
                                    Nhấn vào ảnh để thay đổi (bắt buộc)
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            <label for="user_id"
                                   class="col-md-3 text-md-right col-form-label">Người đăng</label>
                            <div class="col-md-9 col-xl-8">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="title" id="title" placeholder="Nhập tiêu đề" type="text"
                        ...
                        <div class="position-relative row form-group">
                            <label for="subtitle"
                                   class="col-md-3 text-md-right col-form-label">Tiêu đề phụ</label>
                            <div class="col-md-9 col-xl-8">
                                <input required name="subtitle" id="subtitle"
                                       placeholder="Nhập tiêu đề phụ" type="text" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="category" id="category"
                                       placeholder="Nhập danh mục" type="text" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <textarea class="form-control" name="content" id="content" placeholder="Nhập nội dung"></textarea>
                            </div>
                        </div>
