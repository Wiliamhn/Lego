        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-1">
                <div class="filter-control">
                    <ul>
                        <li class="active">Lego Ninjago</li>
                     
                    </ul>
                </div>
                <div class="product-slider owl-carousel">
                    @foreach($featuredProducts['ninja'] as $product)
                    <div class="product-item">
                        <div class="pi-pic">
                            ...
                            <ul>
                                <li class="w-icon active"><a style="background: #e51313" href="javascript:addCart({{$product->id}})"><i class="icon_bag_alt"></i></a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8">
                <div class="filter-control">
                    <ul>
                        <li class="active">Lego Car </li>
                    </ul>
                </div>
                <div class="product-slider owl-carousel">
                    @foreach($featuredProducts['cars'] as $product)
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="front1/img/products/{{$product->productImages[0]->path}}" alt="" style="height: 200px">
                                @if($product->discount != null)
